      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          className={`lg:hidden overflow-hidden transition-all duration-500 ease-in-out ${
            isMenuOpen
              ? "max-h-screen py-4 border-t border-gray-200"
              : "max-h-0"
          }`}
        >
          <div className="flex flex-col space-y-2">
            ...
            <div className="pt-4">
              <Link
                href="/donate"
                onClick={() => setIsMenuOpen(false)}
                className="inline-flex items-center justify-center w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full font-semibold transition-colors"
              >
