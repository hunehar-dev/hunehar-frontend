...
export default function FAQSection() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "We currently operate in 15 countries across Asia, Africa, and South America, focusing on underserved communities where educational resources are most needed. Our programs are designed to work within local cultural contexts and community needs, ensuring sustainable and respectful development.",
    },
    {
          ...
          <Accordion type="single" collapsible className="w-full space-y-6">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                <AccordionContent className="text-gray-600 leading-relaxed text-lg pb-6">{faq.answer}</AccordionContent>
              </AccordionItem>
            ))}
          </Accordion>
        </div>
