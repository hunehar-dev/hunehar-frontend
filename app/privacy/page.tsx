  ...
  return (
    <main className="bg-white text-brand-navy min-h-screen">
      ...
      >
        ...
        <h2 className="text-xl font-semibold text-brand-blue mt-8 mb-4">1. Information We Collect</h2>
        ...
        <h2 className="text-xl font-semibold text-brand-blue mt-8 mb-4">2. How We Use Your Information</h2>
        <ul className="list-disc ml-6 space-y-2 mb-4">
        ...
        <h2 className="text-xl font-semibold text-brand-blue mt-8 mb-4">3. Access and Sharing of Data</h2>
        <p className="mb-4 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-brand-blue mt-8 mb-4">4. Data Storage and Security</h2>
        <p className="mb-4 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-brand-blue mt-8 mb-4">5. Data Retention and Deletion</h2>
        <p className="mb-4 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-brand-blue mt-8 mb-4">6. Third-Party Services</h2>
        <p className="mb-4 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-brand-blue mt-8 mb-4">7. Your Rights</h2>
        <ul className="list-disc ml-6 space-y-2 mb-4">
        ...
        <h2 className="text-xl font-semibold text-brand-blue mt-8 mb-4">8. Contact Us</h2>
        <p className="mb-4 leading-relaxed">
